...
public class ScrollHandler extends Group {
    ...
    public void meterAsteroides(int speed, int gap, int cantidad){
        ...
        Asteroid asteroid = new Asteroid(Settings.GAME_WIDTH, r.nextInt(Settings.GAME_HEIGHT - (int) newSize), newSize, newSize, speed,false);
        ...
        for (int i = 1; i < numAsteroids; i++) {
            ...
            // Afegim l'asteroid.
            asteroid = new Asteroid(asteroids.get(asteroids.size() - 1).getTailX() + gap, r.nextInt(Settings.GAME_HEIGHT - (int) newSize), newSize, newSize, speed,false);
